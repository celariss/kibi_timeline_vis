...
//import RequestQueueWrappedProvider from './lib/courier/_request_queue_wrapped';
...
// didn't already
const module = uiModules.get('kibana/kibi_timeline_vis', ['kibana']);

module.controller('KbnTimelineVisController',
  function (createNotifier, $location, $rootScope, $scope, $route, savedSearches, savedVisualizations,
    Private, Promise, courier, timefilter, indexPatterns) {

    const notify = createNotifier({
      location: 'Kibi Timeline'
    });
    const SearchSource = Private(SearchSourceProvider);
    const requestQueue = require('ui/courier/_request_queue');
